...
save('NSDSynth_Groupavg_5roi_2tasks_72groups_mnandse_b2_ver2.mat','gmean2','gse2'); 
...
for i = 1:5
        ...
        drop0 = '/home/stone/generic/Dropbox/nsdanalysis/asha/NSD_Synth/Beta_2';
        nam = sprintf('%s/Group_Average/',drop0);
        filename0 = sprintf('NSDSyn_Group_Average_b2_fixed');
