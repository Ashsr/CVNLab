...
test1 = fileread('Allfandw_via_export_json_1.json');
load im.mat
...
cmap = [0,0,0
    ...
    0.4,0.4,0
    0,0.4,0.4];
lbl = {'Clear','Occluded','Blurry','Alphanumeric','Numbers or special characters','Different orientation'};
video = VideoWriter('Rand20_words1.avi'); %create the video object
video.FrameRate = 1;
open(video);
