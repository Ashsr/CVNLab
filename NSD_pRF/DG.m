...
% position - Demeaned version for 10k (actual)
clear all 
        ...
        for roi = 1:roi_c,roi % Loop over ROIs
            ...
            if (~isempty(vert_no))
                ...
                results = analyzePRF(bmaps2(:,:,rept(subjix,1,1:totimg(subjix))), ...
                    tr_avg,1,struct('hrf',1,'maxpolydeg',0,'seedmode',1,'typicalgain',0.01));
...
save('RR&Aprf.mat','bmaps2','x','xstd','data','CoefsR2_val','Analyzeprf_results','-v7.3')
