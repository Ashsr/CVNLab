...
%   imwrite(rgbimg,sprintf('Subject%02d/face_nonface_13_tvals_subj%02d.png',subj,subj));
%   cvnlookup('fsaverage',13,angvals,[-45,45]);
%   imwrite(rgbimg,sprintf('Subject%02d/face_nonface_13_angvals_subj%02d.png',subj,subj));
%  
%    cvnlookup('fsaverage',13,angvals,[-45 45],[],[],[],1,{'overlayalpha' abs(tvals)>3});
%    imwrite(rgbimg,sprintf('Subject%02d/face_nonface_13_tval_overlay_angmet_subj%02d.png',subj,subj));
%    
%   cvnlookup('fsaverage',3,tvals,[-mn mn]);
%   imwrite(rgbimg,sprintf('Subject%02d/face_nonface_3_tvals_subj%02d.png',subj,subj));
%   cvnlookup('fsaverage',3,angvals,[-45,45]);
%   imwrite(rgbimg,sprintf('Subject%02d/face_nonface_3_angvals_subj%02d.png',subj,subj));
%  
%   cvnlookup('fsaverage',3,angvals,[-45 45],[],[],[],1,{'overlayalpha' abs(tvals)>3});
%   imwrite(rgbimg,sprintf('Subject%02d/face_nonface_3_tval_overlay_angmet_subj%02d.png',subj,subj));
cvnlookup('fsaverage',3,tvals,[-mn mn],[],3);
imwrite(rgbimg,sprintf('Subject%02d/face_nonface_3_tvals_subj%02d_thresh3.png',subj,subj));
end