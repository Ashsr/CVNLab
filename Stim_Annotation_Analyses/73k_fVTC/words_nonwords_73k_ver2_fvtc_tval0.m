% T-test against 0 for words - non words in 73k stimulus images for
...
for subjix = 1:nsubj, subjix % Loop over subjects
    ...
    imwrite(rgbimg,sprintf('Subject%02d/word_nonword_3_tvals_10k_subj%02d_tval0.png',subjix,subjix));
    
    
    close all
end
save('words_nonwords_73k_fVTC_full_tval0.mat','am_tvals','-v7.3')
